package CodeChallange.HomeWork;
...
public class Task01_Amazon extends BaseTest {
        ...
        public void test() {
            ...
            email.sendKeys("#####MAIL ADRESI#####" + Keys.ENTER);
            WebElement password = driver.findElement(By.id("ap_password"));
            password.sendKeys("#####SIFRE#####" + Keys.ENTER);
            //   Login işlemi kontrol edilir.
            WebElement accountName = driver.findElement(By.id("nav-link-accountList-nav-line-1"));
            Assert.assertTrue(accountName.getText().contains("#####KULLANICI ISMI#####"));
